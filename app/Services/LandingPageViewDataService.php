    ...
    public function homeData(Collection $landingBanners, Collection $landingSections, Collection $shopLookProducts): array
    {
        ...
        $defaultBanners = collect([
            (object) [
                ...
                'primary_button_url' => route('collections.show', ['slug' => 'new-arrival']),
        ...
        $defaultSections = collect([
            (object) [
                ...
                'button_url' => route('collections.show', ['slug' => 'best-seller']),
                'image' => null,
            ...
            (object) [
                ...
                'button_text' => 'Explore',
                'button_url' => route('collections.show', ['slug' => 'new-arrival']),
                'image' => null,
