    ...
    <style>
        ...
        .auth-bg {
            background:
                ...
                radial-gradient(circle at 12% 20%, rgba(167, 139, 111, .22), transparent 28%),
                radial-gradient(circle at 88% 76%, rgba(95, 74, 58, .14), transparent 26%);
        }
    ...
    <main class="min-h-screen grid lg:grid-cols-[1fr_520px]">
        <section class="hidden lg:flex relative overflow-hidden px-12 py-10 flex-col justify-between">
            <a href="/" class="inline-flex items-center gap-3 w-fit">
                ...
                <span class="text-brand-dark font-extrabold text-2xl tracking-tight uppercase">FURE</span>
            </a>
