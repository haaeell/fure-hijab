...
<head>
    ...
    <title>Reset Password Al-Hayya</title>
</head>
        ...
        <tr>
            <td align="center">
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:24px;overflow:hidden;border:1px solid #e5e7eb;">
                    <tr>
                        <td style="background:#2D5A27;padding:28px 32px;color:#ffffff;">
                            <div style="font-size:12px;letter-spacing:2px;text-transform:uppercase;color:#A5D6A7;font-weight:700;">Al-Hayya Hijab</div>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 22px;font-size:15px;line-height:1.7;color:#4b5563;">
                                Kami menerima permintaan untuk mengganti password akun Al-Hayya Anda. Klik tombol di bawah untuk membuat password baru.
                            </p>
                            <p style="margin:0 0 26px;text-align:center;">
                                <a href="{{ $url }}" style="display:inline-block;background:#81C784;color:#ffffff;text-decoration:none;font-weight:700;padding:14px 24px;border-radius:14px;">
                                    Reset Password
                                </a>
                            </p>
                            ...
                            <p style="margin:18px 0 0;font-size:12px;line-height:1.6;color:#9ca3af;">
                                ...
                                <span style="word-break:break-all;color:#2D5A27;">{{ $url }}</span>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:18px 32px;background:#F1F8E9;color:#2D5A27;font-size:12px;text-align:center;">
                            Email otomatis dari Al-Hayya Hijab. Mohon tidak membalas email ini.
                        </td>
                    </tr>
                </table>
            </td>
